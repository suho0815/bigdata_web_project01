...
const Nav = () => {
  ...
  return (
    <header className="fixed z-20 w-full md:h-16 h-28 md:before:h-0 before:h-10 before:w-full before:absolute before:bg-lightmint bg-mint">
        ...
        <Div className="w-full">
          ...
          <Div className="w-full">
            <Div className="absolute w-full h-16 top-11 md:hidden">
              <ul className="flex items-center justify-center h-full text-xl font-bold text-white">
